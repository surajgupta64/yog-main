    ...
    return (
        <CCard className="mb-3 border-success">
            <CCardHeader style={{ backgroundColor: '#0B5345', color: 'white' }}>
                <CCardTitle>Teacher Training Course</CCardTitle>
            </CCardHeader>
            <CCardBody>
                <CForm>
                    <CRow>
                        ...
                        <CCol xs={3}>
                            <CButton className="mt-2 float-end me-3 " onClick={() => setLiveClass(!liveClass)} >{!liveClass ? 'Add TTC Batch' : 'Close'}</CButton>
                        </CCol>
                    </CRow>
                </CForm>
                ...
                <CCard className='mt-3'>
                    <CCardHeader>
                        All Teacher Training Course Batch
                    </CCardHeader>
                    <CCardBody>
                        <CRow>
