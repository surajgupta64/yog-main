        ...
        <CRow>
            <CCol lg={12} sm={12}>
                <CCard className='mb-3 border-top-success border-top-3'>
                    <CCardHeader>
                        <strong className="mt-2">Enquires Appointment <span className='float-end'>Total Appointment : 0</span></strong>
                    </CCardHeader>
                    <CCardBody>
                            ...
                            <CCol lg={6} sm={6} md={6}>
                                <div className='d-flex justify-content-between float-end'>
                                    <CButtonGroup style={{ fontSize: '11px' }} role="group" aria-label="Basic example">
                                        <CButton style={{ fontSize: '11px' }} color="dark" variant="outline">Complate: 0</CButton>
                                        <CButton style={{ fontSize: '11px' }} color="dark" variant="outline">Confirmed:0</CButton>
                                        <CButton style={{ fontSize: '11px' }} color="dark" variant="outline">Pending: 0</CButton>
                                        <CButton style={{ fontSize: '11px' }} color="dark" variant="outline">Cancel: 0</CButton>
                                    </CButtonGroup>
                                </div>
                            </CCol>
                        </CRow>
